...
def analyze_command():
    ...
    print ("Analayze command executes the input command and returns the analysis result for as question asked.")
    ...
    prompt_template = PromptTemplate.from_template(
        ...
        User wants to know: '{user_query}'. Provide output in bulleted summary.
